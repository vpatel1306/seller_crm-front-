...
function WrongReturnClaimSidebar({ groupedData }) {
...
export default function WrongReturnClaim() {
  const renderSidebar = useMemo(
    () =>
      ({ groupedData }) =>
        <WrongReturnClaimSidebar groupedData={groupedData} />,
    []
  );

  return (
    <CommonOrderPage
      title="Wrong Return Claim"
      breadcrumbLabel="Wrong Return Claim"
