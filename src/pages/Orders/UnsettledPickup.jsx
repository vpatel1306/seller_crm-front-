...
const DEMO_ORDERS = [
  ...
  },
  {
    ...
    buyer_name: 'Sasikala No. 6 Anandha pett',
    sku: 'C',
  },
  {
    id: 4,
  ...
  {
    id: 8,
    order_number: '132382678137110656_1',
    order_date: '15/03/2025',
    pickup_date: '17/03/2025',
    days: 117,
    status: 'CANCELLED',
    awb_number: 'VL0080647950461',
    courier: 'Valmo',
    packet_qr_id: '',
    buyer_name: 'raju goswami jamunaha majh',
    sku: 'B',
  },
];

const COURIER_SUMMARY = [
  { courier: 'Valmo', pickup: 367, amount: '94665.00' },
  { courier: 'Delhivery', pickup: 46, amount: '11670.00' },
  { courier: 'Shadowfax', pickup: 33, amount: '8835.00' },
  { courier: 'Ecom Express', pickup: 9, amount: '2250.00' },
  { courier: 'Xpress Bees', pickup: 1, amount: '350.00' },
];

const PICKUP_DATE_SUMMARY = [
  { date: '10/07/2025', count: 33, amount: '7800.00' },
  { date: '08/07/2025', count: 119, amount: '31435.00' },
  { date: '05/07/2025', count: 19, amount: '5245.00' },
  { date: '04/07/2025', count: 23, amount: '7250.00' },
  { date: '03/07/2025', count: 58, amount: '14195.00' },
  { date: '01/07/2025', count: 38, amount: '8910.00' },
  { date: '30/06/2025', count: 57, amount: '13475.00' },
];

const STATUS_SUMMARY = [
  { status: 'DELIVERED', count: 172, amount: '42420.00' },
  { status: 'SHIPPED', count: 149, amount: '39545.00' },
  { status: 'CANCELLED', count: 100, amount: '27575.00' },
  { status: 'READY-TO-SHIP', count: 34, amount: '8230.00' },
  { status: '', count: 1, amount: '0.00' },
];
    ...
    <div className="border border-[#d7d7d7] bg-white">
      ...
      <div className="grid grid-cols-2 divide-x divide-[#e6e6e6] text-center">
        <div className="px-1 py-2">
          ...
          <div className="mt-1 text-[14px] font-bold text-[#4aa04a]">0.00 %</div>
        </div>
        <div className="px-1 py-2">
          <div className="text-[12px] font-bold text-[#cf8c3f]">Pending</div>
          <div className="mt-1 text-[14px] font-bold text-[#cf8c3f]">0.00 %</div>
        </div>
      </div>
      <div className="grid grid-cols-3 border-t border-[#e6e6e6] text-center text-[11px]">
        <div className="border-r border-[#e6e6e6] px-1 py-2">
          ...
          <div className="mt-1 text-[14px] font-bold text-[#d45555]">0</div>
        </div>
        <div className="border-r border-[#e6e6e6] px-1 py-2">
          <div className="font-bold text-[#4aa04a]">Clear</div>
          <div className="mt-1 text-[14px] font-bold text-[#4aa04a]">0</div>
        </div>
        <div className="px-1 py-2">
          <div className="font-bold text-[#cf8c3f]">Pending</div>
          <div className="mt-1 text-[14px] font-bold text-[#cf8c3f]">456</div>
        </div>
      </div>
    </div>
  );
            ...
            <div className="flex-1 overflow-hidden bg-[#f7f6df]">
              <div className="overflow-hidden border-b border-[#d0d0d0]">
                <DataTable
                  ...
                  data={sortedOrders}
                  loading={false}
                  emptyText="No unsettled pickup records found."
