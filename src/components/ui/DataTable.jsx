...
export default function DataTable({
  ...
  headerCellClassName = 'px-3.5 py-2 text-[0.65rem] font-bold uppercase tracking-widest text-slate-500 transition-colors',
  indexHeaderClassName = 'w-9 border-b border-slate-200 px-3.5 py-2 text-center text-[0.65rem] font-bold text-slate-400',
  rowClassName,
  indexCellClassName = 'px-3.5 py-2 text-center text-xs font-medium text-slate-400',
  cellClassName = 'px-3.5 py-2 text-xs text-slate-600 border-b border-slate-100',
