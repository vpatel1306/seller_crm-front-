            ...
            <div className="flex-1 flex flex-col min-h-0 bg-white rounded-default border border-slate-200 overflow-hidden shadow-soft">
                ...
                <div className="flex-1 min-h-0 overflow-hidden">
                    <DataTable
                        ...
                        headerCellClassName="px-3.5 py-2 bg-slate-50/80 text-[0.65rem] font-black uppercase tracking-[0.15em] text-slate-500 border-b border-slate-200"
                        cellClassName="px-3.5 py-2 text-xs"
